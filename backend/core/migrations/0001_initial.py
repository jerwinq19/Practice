    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('PERSONAL PROBLEMS', 'PERSONAL PROBLEMS'), ('FAMILY PROBLEMS', 'FAMILY PROBLEMS'), ('DEPRESSSION', 'DEPRESSSION'), ('SHARE', 'SHARE')], max_length=50)),
